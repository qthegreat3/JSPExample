...
storageEngine = function() {
    ...
    return {
        init: function(successCallback, errorCallback){
            if(window.indexedDB){
                ...
                request.onerror = function(event){
                    errorCallback('storage_not_initialized', 'It is not possible to initialized storage');
                };
            }else{
        ...
        initObjectStore: function(type, successCallback, errorCallback){
            if(!database){
                errorCallback('storage_api_not_initialized', 'The storage engine api has not been initialized');
            }
